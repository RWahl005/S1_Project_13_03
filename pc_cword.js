...
function formatPuzzle(puzzleLetter) {
      ...
      if (currentLetter.dataset.clueA != undefined) {
            ...
            wordLetters = document.querySelectorAll("[data-clue-a=" + currentLetter.dataset.clueA + "]"); //COULD BE AN ERROR
      ...
      if (currentLetter.dataset.clueD != undefined) {
            ...
            wordLetters = document.querySelectorAll("[data-clue-d=" + currentLetter.dataset.clueD + "]"); //COULD BE AN ERROR
            for (var i = 0; i < wordLetters.length; i++) {
